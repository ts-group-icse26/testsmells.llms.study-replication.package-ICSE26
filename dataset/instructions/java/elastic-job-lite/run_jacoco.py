...
class RunJacoco:
    ...
    def __init__(self):
        ...
        self._jacoco = ('~/.jdks/corretto-1.8.0_432/bin/java -Dmaven.multiModuleProjectDirectory=$(pwd)/elastic-job-lite '
                        ...
                        '-javaagent:/snap/intellij-idea-community/553/lib/idea_rt.jar=43007:/snap/intellij-idea-community/553/bin '
                        ...
                        'org.codehaus.classworlds.Launcher -Didea.version=2024.3 clean test org.jacoco:jacoco-maven-plugin:0.8.12:report-aggregate')
        self.path = os.getcwd()

    def run_jacoco(self):
        print('Run JaCoCo Elastic-Job...')
