...
class RunJacoco:
    ...
    def __init__(self):
        ...
        self._jacoco = ('~/.jdks/corretto-1.8.0_432/bin/java -Dmaven.multiModuleProjectDirectory=$(pwd)/redpipe '
