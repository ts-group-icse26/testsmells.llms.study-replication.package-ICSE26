...
class RunJacoco:
    ...
    def __init__(self):
        ...
        self._jacoco = ('~/.jdks/azul-22.0.2/bin/java -Dmaven.multiModuleProjectDirectory=$(pwd)/vertx-mqtt '
                        ...
                        '-Dmaven.ext.class.path=/snap/intellij-idea-community/553/plugins/maven/lib/maven-event-listener.jar -javaagent:/snap/intellij-idea-community/553/lib/idea_rt.jar=37885:/snap/intellij-idea-community/553/bin '
                        '-Dfile.encoding=UTF-8 -Dsun.stdout.encoding=UTF-8 -Dsun.stderr.encoding=UTF-8 '
                        '-classpath $HOME/.m2/wrapper/dists/apache-maven-3.5.0-bin/6ps54u5pnnbbpr6ds9rppcc7iv/apache-maven-3.5.0/boot/plexus-classworlds-2.5.2.jar '
